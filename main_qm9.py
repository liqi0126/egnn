...
from qm9.egnn import EGNN
from qm9.mc_egnn import MCEGNN
import torch
...
parser.add_argument('--m', type=int, default=2, metavar='N')
...
elif args.model == 'mc_egnn':
    model = MCEGNN(in_node_nf=15, in_edge_nf=0, hidden_nf=args.nf, m=args.m, device=device, n_layers=args.n_layers, coords_weight=1.0,
                   attention=args.attention, node_attr=args.node_attr)
